        ...
        return(
            ...
            <Grid style={{width:"100vw",height:'100vh',backgroundColor:'#c1c2e8'}}>
                ...
                <Grid style={{display:"flex",justifyContent:"space-between",flexDirection:"row",width:'80vw',marginTop:"20vh",marginLeft:"10vw"}}>
                    ...
                    <Grid style={{backgroundColor:"#3872c7",height:'15vw',width:"24vw",display:"flex",flexDirection:'column'}}>

                        <Grid style={{width:'24vw',height:"10vh",backgroundColor:"#2d32b6",display:'flex',justifyContent:'center',alignItems:'center'}}>
                    ...
                    <Grid style={{backgroundColor:"#3872c7",height:'15vw',width:"24vw",display:"flex",flexDirection:'column'}}>
                        ...
                        <Grid style={{margin:"3vh",display:'flex',flexDirection:"column",alignItems:'center',justifyContent:"space-between"}}>
                            <Typography style={{fontSize:"60px",color:"white"}}>50</Typography>
                        </Grid>
                    </Grid>
                    ...
                    <Grid style={{backgroundColor:"#3872c7",height:'15vw',width:"24vw",display:"flex",flexDirection:'column'}}>
                        ...
                        <Grid style={{margin:"3vh",display:'flex',flexDirection:"column",alignItems:'center',justifyContent:"space-between"}}>
                            <Typography style={{fontSize:"60px",color:"white"}}>80</Typography>
                        </Grid>
                    </Grid>
